...
import { FACEBOOK_LINK, INSTAGRAM_LINK, TELEFONO_LINK, TELEFONO_NUMERO, WHATSAPP_LINK, YOUTUBE_LINK } from '@/src/constants/constants';
        ...
        <nav className="flex flex-col">
          ...
          <div className="px-6 py-6 bg-gray-50 flex flex-col items-center">
            <div className="flex items-center justify-center gap-4 mb-4">
              <Link href={INSTAGRAM_LINK} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
              ...
              <Link href={FACEBOOK_LINK} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <Link href={YOUTUBE_LINK} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <Link href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div className="space-y-2 text-center">
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-foreground font-semibold">
                ...
                <Link href={TELEFONO_LINK} className="hover:opacity-80 transition-opacity">
                  {TELEFONO_NUMERO}
                </Link>
              </div>
            </div>
