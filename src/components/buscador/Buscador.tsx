...
export const Buscador = ({ zonas, emprendimientos, operaciones, tipos_inmueble }: Props) => {

   return (
      <Form action={'/propiedades'}>
         <div className="bg-white flex flex-wrap my-5 justify-between gap-10 rounded">
            <div className="my-5 ml-10 flex grow items-center">
               ...
               {/* <UbicacionAutocomplete zonas = {zonas} emprendimientos={emprendimientos}/> */}
               <UbicacionSelect zonas={zonas} emprendimientos={emprendimientos} />
            </div>
